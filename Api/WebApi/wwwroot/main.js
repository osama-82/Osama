...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUserData = function () {
        return this.http.get('/api/Values').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (response) {
            return response;
        }));
    };
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getUserData().subscribe(function (data) {
            _this.userInfo = data;
...
module.exports = __webpack_require__(/*! C:\work\Git\Osama-App\Spa\src\main.ts */"./src/main.ts");
